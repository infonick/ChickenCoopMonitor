...
<main class='container py-5' id='mainSection'>
	<section class='row'>
        <img class="mx-auto" src="http://192.168.1.200:8000/stream.mjpg" width="640" height="480">
	</section>
    ...
    <section class='row'>
        <div class="mx-auto">
            Camera LED: <button type="button" class="btn btn-primary" id='toggleCameraLED'>Toggle On/Off</button>
        </div>
    </section>
...
$(document).ready(function(){
	...
	$('#toggleCameraLED').click(function() {
        //console.log("starting..");
        var data = {page: "Main", command: "cameraLEDToggle"};
